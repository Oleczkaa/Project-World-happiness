...
#The below code creates a list of colors for each continent. To always use the same coloring (for each continent), use this: color_discrete_map=continent_colors
...
#fig.suptitle("Comparison of Indicators from 2005–2023", fontsize=18, fontweight='bold')
...
#Data clean up –> Duplicates & Check if any row is missing more than 50% of the data

#check duplicates

df_dublicates = df_all.duplicated().sum()
print("\n")
print('There are', df_dublicates, 'duplicates.')

#check rows 50%

#.notna() -> True = not-NaN, False = NaN
#.sum(axis=1) -> add True-values
#len() -> div value through all column-values
